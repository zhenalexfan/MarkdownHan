...
(function (global, factory) {
  ...
  var Tokenizer_1 = /*#__PURE__*/function () {
    ...
    _proto.ruby = function ruby(src) {
      var cap = this.rules.inline.ruby.exec(src);
    ...
    _proto.rt = function rt(src) {
      var cap = this.rules.inline.rt.exec(src);
    ...
    _proto.ins = function ins(src) {
      var cap = this.rules.inline.ins.exec(src);
    ...
    _proto.inlineTokens = function inlineTokens(src, tokens, inLink, inRawBlock) {
      ...
      while (src) {
        ...
        if (token = this.tokenizer.ruby(src)) {
          ...
          while (true) {
            var rtToken = this.tokenizer.rt(tokenText);
            ...
            if (rtToken) {
              ...
              if (tokenText.length > 0) {
                innerTokens.push.apply(innerTokens, this.inlineTokens(tokenText));
              }
  ...
  var Renderer_1 = /*#__PURE__*/function () {
    ...
    _proto.ruby = function ruby(text) {
      return '<ruby>' + text + '</ruby>';
    };

    _proto.rt = function rt(text, annotation) {
    ...
    _proto.parseInline = function parseInline(tokens, renderer) {
      ...
      for (i = 0; i < l; i++) {
        ...
        switch (token.type) {
          ...
          case 'rt':
            {
              var textParsed = this.parseInline(token.textTokens, renderer);
              var annotationParsed = this.parseInline(token.annotationTokens, renderer);
